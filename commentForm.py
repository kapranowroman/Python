...
<form>
	...
	<label>Фамилия:</label>
	<input type='text' oninput='validator("LastName")'  id='LastName' name='LastName' placeholder='Иванов'>
	<label>Имя:</label>
	<input type='text' oninput='validator("FirstName")'  id='FirstName' name='FirstName' placeholder='Иван'>
	<label>Отчество:</label>
	<input type='text' oninput='validator("Fathername")' id='Fathername' name='Fathername' placeholder='Иванович' >
	<label>Регион:</label>
	<select onChange='city()' id='Region'></select>
	<label>Город:</label>
	<select id='City'></select>
	<label>Телефон:</label>
	<input type='text' oninput='vphone()' id='Phone' name='Phone' title='+7(000)-000-00-00'>
	<label>E-mail:</label>
